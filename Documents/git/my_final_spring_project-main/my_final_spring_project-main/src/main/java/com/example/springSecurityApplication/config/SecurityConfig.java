...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/authentication/login", "/authentication/registration", "/pr","/error", "/product", "/img/**", "/product/info/{id}","/product/search").permitAll()
...
public void configure(WebSecurity web){
        web.ignoring()
                .antMatchers("/resources/**", "/static/**", "/css/**", "/js/**", "/icon/**");
}
